    ...
    public ProductService create(Throwable throwable) {
        ...
        return new ProductService() {
            ...
            public List<Product> selectProductList() {
                logger.error("serviceSentinelProvider 服务的 selectProductList 方法出现异常，异常信息如下："+throwable);
            ...
            public List<Product> selectProductListByIds(List<Integer> ids) {
                logger.error("serviceSentinelProvider 服务的 selectProductListByIds 方法出现异常，异常信息如下："+throwable);
