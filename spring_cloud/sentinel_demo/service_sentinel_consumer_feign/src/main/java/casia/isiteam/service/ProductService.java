 ...
 */
// 声明需要调用的服务
// 如果 serviceSentinelProvider 服务接口没有启动，则调用 ProductServiceFallback 托底数据
//@FeignClient(value = "serviceSentinelProvider", fallback = ProductServiceFallback.class)
@FeignClient(value = "serviceSentinelProvider", fallbackFactory = ProductServiceFallbackFactory.class)
